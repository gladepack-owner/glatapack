...
scoreboard players operation @s gp_random = @e[type=area_effect_cloud,name="math_random_kcjbc",distance=..1,limit=1] math_input1
scoreboard players operation @s gp_random %= @s math_input2
scoreboard players operation @s gp_random += @s math_input1
...
#scoreboard players reset * gp_random
